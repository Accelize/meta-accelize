 ...
 * Accelize ("Confidential Information"). You shall not
 * disclose such Confidential Information and shall use it only in
 * accordance with the terms of the license agreement you entered
 * into with Accelize
 *
 * ACCELIZE MAKES NO REPRESENTATIONS OR WARRANTIES ABOUT THE
 * SUITABILITY OF THE SOFTWARE, EITHER EXPRESS OR IMPLIED, INCLUDING
 * BUT NOT LIMITED TO THE IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS
 * FOR A PARTICULAR PURPOSE, OR NON-INFRINGEMENT. ACCELIZE SHALL
...
int main(int argc, char **argv) {
    ...
    std::string conf_path("/etc/xilinx_appstore/accelize-drmselftest/xlz-drmselftest-nodelock-conf.json");
    if (!nodelock) {
        conf_path = std::string("/etc/xilinx_appstore/accelize-drmselftest/xlz-drmselftest-floating-conf.json");
    }
    std::string cred_path("/etc/xilinx_appstore/cred.json");
    std::string xclbin("/lib/firmware/xilinx/accelize-drmselftest-firmware/accelize-drmselftest-firmware.xclbin");
